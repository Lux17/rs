...
$query = "INSERT INTO pasien (kd_pasien ,nama_pasien, alamat_pasien, tgl_datang, keluhan, kd_dokter) VALUES ('$kd_pasien','$nama_pasien', '$alamat_pasien', '$tgl_datang', '$keluhan', '$kd_dokter')";
